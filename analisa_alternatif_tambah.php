          ...
          <div class="card bg-light">
            ...
            <nav>
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link" href="analisa_alternatif.php">Tabel Analisa Alternatif</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active" href="analisa_alternatif_tambah.php">Tambah Analisa Alternatif</a>
                </li>
              </ul>
            </nav>

            <div class="card-body">
              <form class="" action="analisa_alternatif_tambah.php" method="post">
