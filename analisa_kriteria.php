          ...
          <div class="card bg-light mb-3">
            ...
            <nav>
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link active" href="analisa_kriteria.php">Tabel Analisa Kriteria</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="analisa_kriteria_tambah.php">Tambah Analisa Kriteria</a>
                </li>
              </ul>
            </nav>
              ...
              <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <a href="analisa_kriteria_hapus.php?id_kriteria=<?php echo $row['id_kriteria'] ?>"><i class="fa fa-trash"></i> </a>
                    </td>
                  </tr>
                  <?php
                  $no++;
