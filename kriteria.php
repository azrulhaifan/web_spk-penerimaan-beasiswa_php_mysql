          ...
          <div class="card bg-light mb-3">
            ...
            <nav>
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link active" href="kriteria.php">Tabel Kriteria</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="kriteria_tambah.php">Tambah Kriteria</a>
                </li>
              </ul>
            </nav>
              ...
              <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <a href="kriteria_edit.php?id_kriteria=<?php echo $row['id_kriteria'] ?>"><i class="fa fa-edit"></i> </a>
                    </td>
                    <td align="center">
                      <a href="kriteria_hapus.php?id_kriteria=<?php echo $row['id_kriteria'] ?>"><i class="fa fa-trash"></i> </a>
                    </td>
                  </tr>
                  <?php
                  $no++;
